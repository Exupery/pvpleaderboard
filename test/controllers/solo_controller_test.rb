...
class SoloControllerTest < ActionDispatch::IntegrationTest
  def test_set_title_and_description
    get "/leaderboards/solo/us"
  ...
  def test_show_leaderboard
    Regions.list.each do |region|
      get("/leaderboards/solo/#{region}/monk/mistweaver")
      assert_response :success
      ...
      assert assigns(:bracket) == "solo_270"
